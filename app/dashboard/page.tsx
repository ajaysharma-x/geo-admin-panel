...
type UserData = {
  ...
  email: string;
  role: 'admin' | 'user';
  loginHistory?: LoginEntry[]; // <-- add this
};
                    ...
                    <>
                        ...
                        {showUsers && (
                            <table className="min-w-full text-left border border-gray-300 dark:border-gray-700">
                                ...
                                <tbody>
                                    {allUsers.map((u) => (
                                        <tr key={u._id} className="bg-white dark:bg-gray-800 border-t dark:border-gray-700 align-top">
                                            <td className="px-4 py-2 border-r">{u.name}</td>
                                            <td className="px-4 py-2 border-r">{u.email}</td>
                                            <td className="px-4 py-2 border-r">{u.role}</td>
